    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light mt-5">
                ...
                <form action="<?php echo URLROOT; ?>index.php?url=users/register" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo URLROOT; ?>index.php?url=users/login" class="btn btn-block">Have an account? Login</a>
                        </div>
                    </div>
                </form>
            </div>
